...
/*   Updated: 2024/12/12 16:47:44 by ilazar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*find_relevant_path(t_shell *shell, char *arg, char **paths,
				char *cmd);
static void	check_permissions(char *filename, int *status);

/* returns an exectuable command,
	or null if command wasn't found.
if necessary prints relevant error msg
	and updates the relevant status variable */
...
/* retruns a null terminated array of the different paths.
